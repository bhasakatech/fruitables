(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    var carouselSections = document.querySelectorAll(
      ".product-section.fresh-vegetables",
    );
    carouselSections.forEach(function (section) {
      initCarousel(section);
    });

    var filterSections = document.querySelectorAll(
      ".product-section.organic-products",
    );
